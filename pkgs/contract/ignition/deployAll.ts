...
const deployAllContracts = async (): Promise<void> => {
  ...
  try {
    ...
    console.log(`   npx hardhat createPair --factory ${factoryAddress} --tokena 0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238 --tokenb 0x431D5dfF03120AFA4bDf332c61A6e1766eF37BDB --network ${network.name}`);
    console.log(`   npx hardhat createPair --factory ${factoryAddress} --tokena 0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238 --tokenb 0xCaC524BcA292aaade2DF8A05cC58F0a65B1B3bB9 --network ${network.name}`);
    console.log(`   npx hardhat createPair --factory ${factoryAddress} --tokena 0x431D5dfF03120AFA4bDf332c61A6e1766eF37BDB --tokenb 0xCaC524BcA292aaade2DF8A05cC58F0a65B1B3bB9 --network ${network.name}`);
    console.log("");
