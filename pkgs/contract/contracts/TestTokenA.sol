...
/**
 * @title TestTokenA
 * @dev Test ERC20 token A for DEX testing purposes with mint functionality
 */
contract TestTokenA is IERC20, Ownable {
    string public constant override name = "Test Token A";
    string public constant override symbol = "TTA";
